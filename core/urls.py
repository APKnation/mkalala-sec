...
path('teacher/book/return/<int:book_id>/', views.teacher_book_return, name='teacher_book_return'),
    ...
    path('admin/reports/export/', views.get_admin_export_attendance_context, name='admin_reports_export'),
    path('admin/reports/generate/', views.get_admin_export_attendance_context, name='admin_reports_generate'),
